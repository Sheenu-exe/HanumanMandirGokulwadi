...
const MainPage = () => {
  return (
    <div className='flex flex-col'>
      <div className="sm:h-[100vh] h-fit bg-cover bg-center bg-[url(https://i.ibb.co/ZKbjzK7/bg.jpg)] flex flex-col-reverse sm:flex-row">
        <div className="flex flex-col left sm:h-screen w-screen h-[70vh]  sm:w-[50vw] gap-6 justify-center bg-opacity-80 p-2">
          <div className="bottom-10 z-10 rounded-lg p-3 flex sm:gap-5 gap-2 animate__animated animate__fadeIn text-black flex-col sm:w-[70vw] w-screen justify-center">
          <p className="sm:text-xl text-sm font-bold">शिवगंज का सुप्रसिद्ध </p>
            <p className="sm:text-5xl text-2xl font-extrabold ">श्री गोकुलवाड़ी हनुमान मंदिर</p>
        ...
        <div className="flex justify-end items-end bg-cover bg-center sm:h-[100vh] h-[40vh] right-0 sm:w-[90vw] w-screen absolute">
        {/* <img src={"https://i.ibb.co/0sj2GVQ/Hanuman-mandir-Photoroom-png-Photoroom.png"} alt="Lord Hanuman" className="h-auto w-auto bottom-0 absolute sm:w-auto sm:h-[75vh] rounded-xl animate__animated animate__fadeIn" /> */}

        </div>
      </div>
      <div className='h-[100vh] bg-orange-400 flex'>
      <div className='absolute -z-[0] w-full h-full flex justify-center items-center'><img src="https://i.ibb.co/yR2dnWP/d536d96637ea7ac107e941f5973e8871-removebg-preview.png" className='rotate opacity-30 h-full' alt="" /></div>
        <div className='w-1/2 h-screen z-10 flex flex-col justify-center items-center'>
        ...
        <div className='w-[50vw] z-10 flex justify-center items-center'>
        <iframe
...
/>
      ...
      <div className='min-h-[90vh] max-h-fit flex'>
        <div className='w-[65vw] h-full flex flex-col justify-center items-center'>
        ...
        <div className='w-[35vw]'>
          <img className='h-full w-auto' src="https://i.ibb.co/4p5LVTc/hanumanji-gys4-Photoroom-png-Photoroom.png" alt="" />
        </div>
      </div>
