  ...
  <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          ...
          <li>
        <a class="text-gray-700 transition hover:text-gray-700/75" href="#">आरती बुकिंग</a>
      </li>

      <li>
        <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> गोकुल युवा संगठन मेम्बरशिप </a>
      </li>

      <li>
        <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> डोनेशन </a>
      </li>
    ...
    <div className="mt-12 border-t border-gray-100 pt-12">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <p className="mt-8 text-xs text-gray-500 sm:mt-0">
          Designed By: Sachin Suresh Parihar <br/>
