...
const Members = () => {
  ...
  const handleDonation = async (e) => {
    ...
    if (!Name || !number || !amount || !profilePic || !paymentScreenshot) {
...
२.₹501 रुपये स्कैनर पे भरके स्क्रीनशॉट फॉर्म के साथ अपलोड करे</p>
        ...
        <div className="w-full sm:h-[80vh] h-fit bg-orange-100 flex justify-center items-center">
